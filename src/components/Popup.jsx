...
const Popup = ({ show, close }) => {
    ...
    return (
        ...
        className='blurry-bg fixed inset-0 bg-gray-200 bg-opacity-30 backdrop-blur-md flex justify-center items-center z-50'>
            <div className="bg-[#333C4B] px-11 py-6 rounded-lg drop-shadow-md text-center flex flex-col gap-2 pop-up">
                <div>
                    <h1 className="font-bold text-xl text-[#D4A056]">Details</h1>
